CULTURE_PROFILES = {
    ...
    "Yoruba": {
        ...
        "visual_theme": {
            "color": "#CD5C5C",  # Warm terracotta/coral
    ...
    "Japanese (Zen)": {
        ...
        "visual_theme": {
            "color": "#D1C9B4",  # Soft neutral beige
    ...
    "Renaissance Italian": {
        ...
        "visual_theme": {
            "color": "#A52A2A",  # Florentine red/deep maroon
